package dcomp.ufs.br.inteligencia.artificial.projeto_final.aima.core;
...
public abstract class CspSolver<VAR extends Variable, VAL> {
	 ...
	 */
	public abstract Optional<Assignment<VAR, VAL>> solve(CSP<VAR, VAL> csp, HashMap<Variable, String> caso);

	/**
	 * Adds a CSP listener to the solution strategy.
	 *
	 * @param listener a listener which follows the progress of the solution
